...
- [x] Eight Blender modeling/render/review cycles: full eight-model studies plus facial reconstruction and authored hairstyles on all four travelers (offline art only)
