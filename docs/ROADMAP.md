...
- [x] Twelve Blender modeling/render/review cycles: full eight-model studies plus facial/profile reconstruction and authored hairstyles on all four travelers (offline art only)
