...
- Blender: fifteen saved review cycles under `art/blender/cycles/`. Latest source is **`cycle_15/characters.blend`** with revised faces, hair and upper garments on all four travelers. All four animals are preserved from cycle 4. Latest folder has front/rear lineups, four outfit closeups and a scout side view. References packed; offline unrigged studies excluded from Godot. Continue from cycle 15, not an earlier generator baseline.
