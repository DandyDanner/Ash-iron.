...
- Blender: eight saved review cycles under `art/blender/cycles/`. Latest source is **`cycle_08/characters.blend`** with reconstructed faces and authored hairstyles on all four travelers; outfits and all four animals are preserved from cycle 4. Latest folder has front/rear lineups, four face closeups and a scout profile. References packed; offline unrigged studies excluded from Godot. Continue from cycle 8, not an earlier generator baseline.
