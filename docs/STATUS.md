...
- Blender: twelve saved review cycles under `art/blender/cycles/`. Latest source is **`cycle_12/characters.blend`** with revised facial profiles and authored hairstyles on all four travelers; outfits and all four animals remain preserved from cycle 4. Latest folder has the traveler lineup and front/side portraits of all four faces. References packed; offline unrigged studies excluded from Godot. Continue from cycle 12, not an earlier generator baseline.
