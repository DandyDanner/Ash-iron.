...
- Agreed next: ore → smelter → ingots → an iron weapon upgrade. Approved later wildlife: Woodland Hog, Ridgeback Boar, Meadow Buck; bear later. Keep the current clearing while proving the loop.
