...
Choose **Begin your journey** to enter the existing first-person clearing. Sleeves and hands reflect the chosen colors; the HUD shows the name, background, and keepsake. Press **C** to edit again; your progress in the clearing is saved first and restored when you continue. Once a saved clearing exists the main button reads **Continue your journey**, and **Start over** (it asks twice) erases the clearing while keeping your traveler.
